...
}, "/home/mehan/Step_7/calibraint/dosales-clerk/node_modules/astro/components/Image.astro", void 0);
...
}, "/home/mehan/Step_7/calibraint/dosales-clerk/node_modules/astro/components/Picture.astro", void 0);
...
}, "/home/mehan/Step_7/calibraint/dosales-clerk/node_modules/astro/components/Font.astro", void 0);
...
async function loadImage(src, headers, imageConfig2, isRemote, fetchFn) {
  try {
    const res = await fetchWithRedirects({ url: src, headers, imageConfig: imageConfig2, fetchFn });
    if (isRemote && !isRemoteAllowed(res.url, imageConfig2)) {
      return void 0;
    }
    if (!res.ok) {
      return void 0;
...
const GET = async ({ request }) => {
  try {
    ...
    inputBuffer = await loadImage(
      sourceUrl,
      isRemoteImage2 ? new Headers() : request.headers,
      imageConfig,
      isRemoteImage2
    );
    if (!inputBuffer) {
